...
export default function AuthPage() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen relative flex items-center justify-center overflow-hidden bg-gradient-to-br from-pink-50 via-rose-50 to-pink-50 animate-fade-in">
        {/* Top controls */}
        ...
        <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-pink-200/40 rounded-full blur-[100px] animate-pulse" />
        <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-rose-200/40 rounded-full blur-[100px] animate-pulse delay-1000" />
        <div className="absolute top-[40%] left-[60%] w-[20%] h-[20%] bg-pink-100/30 rounded-full blur-[80px] animate-bounce duration-[5000ms]" />
          ...
          <div className="bg-white/60 backdrop-blur-xl rounded-[2.5rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white/50 p-8 sm:p-10 transition-all duration-500 hover:shadow-[0_20px_40px_rgb(0,0,0,0.08)] animate-fade-in delay-200">
            ...
            <div className="text-center mb-10 animate-slide-up-card delay-300">
              <div className="relative inline-block mb-6 group animate-scale-in delay-100">
                <div className="absolute inset-0 bg-pink-400/20 rounded-2xl blur-xl group-hover:blur-2xl transition-all duration-500" />
                <div className="relative w-20 h-20 bg-gradient-to-br from-pink-400 to-rose-400 rounded-2xl flex items-center justify-center shadow-lg transform group-hover:scale-105 transition-all duration-500 text-white">
            ...
            <form onSubmit={handleSubmit} className="space-y-6 animate-slide-up-card delay-600">
              ...
              <div className="flex justify-center">
                <Button
                  ...
                  className="w-[200px] sm:w-auto sm:min-w-[200px] bg-gradient-to-r from-pink-400 to-rose-400 hover:from-pink-500 hover:to-rose-500 text-white rounded-2xl"
                  icon="login"
                >
